...
import { ConflictError, LimitError, ProcessControlUnavailableError, ProcessIdentityUnverifiedError, ProcessTerminationTimeoutError } from "../core/errors.js";
import { resolveExecutablePath } from "../core/executable-resolution.js";
import { sanitizedChildEnvironment } from "./process-policy.js";
import { completeUtf8Span } from "../core/utf8-boundary.js";
    ...
    try {
      ...
      if (persistent) {
        ...
        const wrapperPath = existsFile(localWrapperPath)
          ? localWrapperPath
          : path.resolve(moduleDirectory, "../../dist/process/process-wrapper.js");
