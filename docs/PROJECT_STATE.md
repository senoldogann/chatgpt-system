...
- Fresh exact-tip verification for this branch at `12d65e45b3cc1165f6e7794838deb3dd3bd488b8` passed: `npm run check` exit 0, 125 files (124 passed, 1 skipped), 810 tests (808 passed, 2 skipped). This handoff edit changes that tip, so the gate must be rerun and recorded against the new commit before publication.
